            ...
            <div className="relative flex flex-col gap-8 p-8 md:flex-row md:items-start md:p-10">
              ...
              <div className="flex-shrink-0 md:w-72">
                ...
                <div className="mt-6 flex flex-col gap-2">
                  <a
                    href="https://github.com/Zachary-Companies/comp-screenplay-generator"
                    target="_blank"
                  ...
                  <p className="text-center text-[11px] text-slate-600">Clone into ~/.woodbury/workflows/ to install</p>
                </div>
              </div>
            </div>
          </div>
