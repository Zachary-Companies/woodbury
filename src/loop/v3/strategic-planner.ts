...
export class StrategicPlanner {
  ...
  private inferPreferredSkill(description: string): string {
    ...
    if (/(asset|collection|storyboard|creator-assets|assets\.json|collections\.json|__asset__|built-in node|woodbury collection|woodbury asset|context\.progress|progress bar|script node progress|loop progress)/.test(lower)) return 'woodbury_builtin_concepts';
